                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pages.store') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label>Başlık</label>
                                    <input name="name" class="form-control" placeholder="Başlık" value="{{ old('name') }}" required>
                                </div>
                                <div class="form-group">
                                    <label>Dış Url</label>
                                    <input name="section_url" class="form-control" value="{{ old('section_url') }}" placeholder="Dış Url Adresi (https://www.ornek.com)">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="seo_desc" maxlength="160" class="form-control" id="placement" value="{{ old('seo_desc') }}" placeholder="Seo Açıklaması">
                                </div>

                                <div class="form-group">
                                    <label>Seo Anahtar Kelimeler</label>
                                    <input name="seo_keywords" maxlength="200" class="form-control" id="placement" value="{{ old('seo_keywords') }}" placeholder="Seo Anathar Kelimeler virgül ile ayrılmış">
                                </div>
