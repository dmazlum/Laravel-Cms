                    ...
                    <div class="card pricing-box mt-4">
                        ...
                        <div class="pricing-content">
                            ...
                            <div class="mt-4 pt-3 text-center">
                                <a href="{{ route('admin.categories') }}" class="btn btn-success btn-lg w-100 btn-round">Listele</a>
                            </div>
                        </div>
                    </div>
                </div> <!-- end col -->
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="card pricing-box mt-4">
                        ...
                        <div class="pricing-content">
                            ...
                            <div class="mt-4 pt-3 text-center">
                                <a href="{{ url('/admin/pages/welcome') }}" class="btn btn-primary btn-lg w-100 btn-round">Listele</a>
                            </div>
                        </div>
                    </div>
                </div>
