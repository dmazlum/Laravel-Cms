                        ...
                        <div class="card-body">
                            <form action="{{ route('news.update', $news->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    <label>Başlık</label>
                                    <input name="subject" class="form-control" placeholder="Başlık" value="{{ $news->subject }}" required>
                                </div>
                                <div class="form-group">
                                    <label>İçerik</label>
                                    <textarea name="content" id="summernote" required>{{ $news->content }}</textarea>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select name="status" class="form-control" required>
                                                    ...
                                                    {!! \App\Helpers\DropDown::get_status($news->status) !!}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div>
                                        ...
                                        <a href="{{ route('admin.news') }}" class="btn btn-secondary waves-effect m-l-5">
                                            İptal
                                        </a>
                                    </div>
                                </div>
