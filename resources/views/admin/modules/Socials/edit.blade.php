                        ...
                        <div class="card-body">
                            <form action="{{ route('socials.update', $social->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Adı</label>
                                    <input name="social_name" type="text" class="form-control" placeholder="Adı" value="{{ $social->social_name }}" required/>
                                </div>

                                <div class="form-group">
                                    <label>Bağlantı Adresi</label>
                                    <div>
                                        <input name="social_url" type="url" class="form-control"
                                               parsley-type="url"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select name="icon" class="form-control" required>
                                                    ...
                                                    {!! \App\Helpers\DropDown::get_icons($social->icon) !!}
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select name="status" class="form-control" required>
                                                    <option value="">Lütfen Seçiniz</option>
                                                    {!! \App\Helpers\DropDown::get_status($social->status) !!}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
